...
class GeneratorOptions(QtWidgets.QWizardPage):
    def __init__(self, parent=None):
        ...
        modLayout_row += 1
        modLayout.addWidget(
            QtWidgets.QLabel("LN Eurofighter Typhoon"), modLayout_row, 0
        )
        modLayout.addWidget(eurofighter, modLayout_row, 1)
        modLayout_row += 1
        modLayout.addWidget(QtWidgets.QLabel("CB Rafale"), modLayout_row, 0)
        modLayout.addWidget(rafale, modLayout_row, 1)
        modLayout_row += 1
        modLayout.addWidget(QtWidgets.QLabel("VSN FA-18F"), modLayout_row, 0)
        modLayout.addWidget(vsn_f18f, modLayout_row, 1)
        modLayout_row += 1
        modLayout.addWidget(QtWidgets.QLabel("VSN EA-6B"), modLayout_row, 0)
